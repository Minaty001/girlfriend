...
const WaveformMessage = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3 py-2 px-3 rounded-lg bg-black/5 dark:bg-white/10 max-w-[280px]"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: handleTogglePlay,
    className: `w-9 h-9 rounded-full flex items-center justify-center transition-all shadow-sm ${sender === 'ai' ? 'bg-pastelPink-400 text-white dark:bg-plum-500 hover:scale-105 active:scale-95' : 'bg-white text-pastelPink-500 dark:bg-plum-950 dark:text-plum-300 hover:scale-105 active:scale-95'}`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: isPlaying ? 'pause' : 'play',
    className: "w-4 h-4 fill-current"
  })), /*#__PURE__*/React.createElement("div", {
    className: "flex items-end gap-[3px] h-8 flex-1"
  }, bars.map((height, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    className: `w-[3px] rounded-full transition-all duration-300 ${sender === 'ai' ? 'bg-pastelPink-400 dark:bg-plum-300' : 'bg-white/80 dark:bg-plum-200'} ${isPlaying ? 'waveform-bar-active' : ''}`,
    style: {
      height: `${height}%`,
    ...
    className: "text-xs opacity-75 font-mono select-none"
  }, duration));
};
...
const App = () => {
  ...
  // Memories log state
  const [memories, setMemories] = useState(["Hates Cilantro", "Birthday: Oct 14", "Loves Indie Rock", "Has a dog named Max"]);
  ...
  const moodStates = [{
    label: 'Content',
    emoji: '😊',
    subline: '✨ Feeling content'
  }, {
    label: 'Flirty',
    emoji: '😏',
    subline: '💕 Thinking of you'
  }, {
    label: 'Excited',
    emoji: '🤩',
    subline: '🌟 Super excited!'
  }, {
    label: 'Tired',
    emoji: '😴',
    subline: '💤 A bit sleepy'
  }];
  const suggestedPrompts = [{
    title: "Ask for a sweet joke",
    text: "What's your name, and tell me a sweet joke! 🌸"
  }, {
    title: "Tease your companion",
    text: "Hmph, why do you always keep me waiting? Baka! 😤"
  }, {
    title: "Get wise advice",
    text: "Can you give me some guidance on a tough decision? 📚"
  }, {
    title: "Share deep thoughts",
    text: "What are your deepest thoughts about connection? 🌧️"
  }];
  ...
  useEffect(() => {
    const greetingText = currentGenderMode === 'girlfriend' ? LOCAL_RESPONSES.girlfriend.greeting[0] : LOCAL_RESPONSES.boyfriend.greeting[0];
    setMessages([{
      id: 'welcome-msg',
      role: 'ai',
    ...
    typingIntervals.current[msgId] = setInterval(() => {
      setMessages(prev => {
        ...
        if (index < text.length) {
          ...
          const newMsgs = prev.map(m => m.id === msgId ? {
            ...m,
            text: typedText
          } : m);
          index++;
  ...
  const handleSendMessage = async (textToSend, customType = 'text', customMedia = null) => {
    ...
    setTimeout(async () => {
      ...
      const newCompanionMessage = {
        id: companionMsgId,
        role: 'ai',
        text: companionType === 'text' ? '' : responseText,
        // typed if text
        type: companionType,
  ...
  const getIntimacyLevel = points => {
    ...
    if (points < 1000) return {
      ...
      nextMin: 500,
      nextMax: 1000,
      color: 'from-rose-400 to-pastelPink-400'
    };
    if (points < 5000) return {
      ...
      nextMin: 1000,
      nextMax: 5000,
      color: 'from-pastelPink-400 to-purple-500'
    };
    return {
      name: 'Eternal Partner',
      icon: '♾️',
      nextMin: 5000,
      nextMax: 10000,
  ...
  const modSelectorItems = [{
    ...
    name: 'Yandere',
    emoji: '💜',
    desc: 'Sweet & obsessive'
  }, {
    key: 'dere',
    name: 'Dere Dere',
    emoji: '💕',
    desc: 'Intensely loving'
  }, {
    key: 'emo',
    name: 'Emo',
    emoji: '🌧️',
    desc: 'Existential & poetic'
  }];
  return /*#__PURE__*/React.createElement("div", {
    className: "flex w-full h-screen overflow-hidden text-sm md:text-base font-body bg-cream-50 dark:bg-plum-950 transition-colors duration-500"
  }, /*#__PURE__*/React.createElement("aside", {
    className: `fixed lg:static inset-y-0 left-0 w-80 lg:w-[340px] z-40 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out glass-panel border-r flex flex-col h-full`
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-4 border-b border-pastelPink-100/30 dark:border-plum-800 flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-xl heart-beat"
  }, "\uD83D\uDC96"), /*#__PURE__*/React.createElement("span", {
    className: "font-heading font-semibold text-lg bg-gradient-to-r from-pastelPink-500 to-purple-600 dark:from-pastelPink-300 dark:to-plum-400 bg-clip-text text-transparent"
  }, "Xiao Wei Companion")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setSidebarOpen(false),
    className: "lg:hidden p-1.5 rounded-full hover:bg-pastelPink-100/50 dark:hover:bg-plum-800 text-pastelPink-400"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "x",
    className: "w-5 h-5"
  }))), /*#__PURE__*/React.createElement("div", {
    ...
    className: "glass-panel rounded-2xl p-4 flex flex-col items-center text-center relative overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "relative group"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-24 h-24 rounded-full overflow-hidden border-2 border-pastelPink-300 dark:border-purple-600 shadow-md"
  }, /*#__PURE__*/React.createElement("img", {
    src: "/xiaowei_avatar.jpg",
    alt: "Xiao Wei Avatar",
    className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
  })), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-0 right-0 w-6 h-6 rounded-full bg-cream-50 dark:bg-plum-950 flex items-center justify-center border border-pastelPink-100/30"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-xs"
  }, moodStates[moodVal].emoji))), /*#__PURE__*/React.createElement("h3", {
    className: "font-heading font-semibold text-lg mt-3"
  }, "\u5C0F\u8587 (Xiao Wei)"), /*#__PURE__*/React.createElement("div", {
    className: "w-full mt-3 px-2"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center text-xs text-pastelPink-500 dark:text-purple-400 mb-1"
  }, /*#__PURE__*/React.createElement("span", null, "Mood Status"), /*#__PURE__*/React.createElement("span", {
    className: "font-medium"
  }, moodStates[moodVal].label, " ", moodStates[moodVal].emoji)), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: "0",
    max: "3",
    value: moodVal,
    ...
    className: "font-heading font-medium text-pastelPink-500 dark:text-purple-400"
  }, "Intimacy Status"), /*#__PURE__*/React.createElement("span", {
    className: "text-xs bg-pastelPink-100 dark:bg-plum-800 text-pastelPink-600 dark:text-plum-300 px-2 py-0.5 rounded-full font-semibold"
  }, "Lv.", localState.level)), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-xs text-pastelPink-400 dark:text-purple-300 mb-1"
  }, /*#__PURE__*/React.createElement("span", null, intimacyInfo.name), /*#__PURE__*/React.createElement("span", null, localState.affection, " Affinity Points")), /*#__PURE__*/React.createElement("div", {
    className: "relative w-full h-3.5 bg-pastelPink-100 dark:bg-plum-900 rounded-full overflow-visible border border-pastelPink-200/50 dark:border-plum-800"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      width: `${intimacyProgress}%`
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute right-[-4px] top-[-3px] w-5 h-5 rounded-full bg-white dark:bg-plum-950 border border-pastelPink-300 dark:border-purple-600 flex items-center justify-center shadow-md"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "heart",
    className: "w-3 h-3 text-pastelPink-400 dark:text-purple-400 fill-current heart-beat"
  })))), /*#__PURE__*/React.createElement("div", {
    className: "mt-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex justify-between items-center text-[10px] text-pastelPink-400 dark:text-purple-300 mb-0.5"
  }, /*#__PURE__*/React.createElement("span", null, "XP Level Progress"), /*#__PURE__*/React.createElement("span", null, localState.xp, "%")), /*#__PURE__*/React.createElement("div", {
    className: "w-full h-1.5 bg-pastelPink-100/50 dark:bg-plum-900/50 rounded-full overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "h-full bg-pastelPink-300 dark:bg-purple-600 transition-all",
    style: {
      width: `${localState.xp}%`
    }
  })))), /*#__PURE__*/React.createElement("div", {
    className: "glass-panel rounded-2xl p-4 flex flex-col max-h-56"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between mb-2"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-heading font-medium text-pastelPink-500 dark:text-purple-400 flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement("span", null, "Things I Remember")), /*#__PURE__*/React.createElement("button", {
    ...
    name: showAddMemInput ? 'x' : 'plus',
    className: "w-4 h-4"
  }))), showAddMemInput && /*#__PURE__*/React.createElement("div", {
  ...
  }, memories.length === 0 ? /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-pastelPink-400 dark:text-purple-400 block text-center py-4"
  }, "No memories recorded yet.") : /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-1.5"
  }, memories.map((tag, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    ...
    className: "font-heading font-medium text-pastelPink-500 dark:text-purple-400 block mb-2.5"
  }, "Gender Mode"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-2 bg-pastelPink-100/50 dark:bg-plum-900/50 p-1 rounded-xl"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setCurrentGenderMode('girlfriend'),
    className: `py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 transition-all ${currentGenderMode === 'girlfriend' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400 hover:text-pastelPink-600 dark:text-plum-300'}`
  }, "\uD83D\uDC69 Girlfriend"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setCurrentGenderMode('boyfriend'),
    className: `py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 transition-all ${currentGenderMode === 'boyfriend' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400 hover:text-pastelPink-600 dark:text-plum-300'}`
  }, "\uD83D\uDC68 Boyfriend"))), /*#__PURE__*/React.createElement("div", {
    className: "glass-panel rounded-2xl p-4"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-heading font-medium text-pastelPink-500 dark:text-purple-400 block mb-3"
  }, "Quick Configurations"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 gap-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-xs"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-pastelPink-400 dark:text-purple-300"
  }, "Voice Pitch"), /*#__PURE__*/React.createElement("div", {
    className: "flex bg-pastelPink-100/50 dark:bg-plum-900/50 p-0.5 rounded-lg border border-pastelPink-200/50 dark:border-plum-800"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setVoicePitch('sweet'),
    className: `px-2.5 py-1 rounded-md text-[10px] font-semibold transition-all ${voicePitch === 'sweet' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, "Sweet"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setVoicePitch('mature'),
    className: `px-2.5 py-1 rounded-md text-[10px] font-semibold transition-all ${voicePitch === 'mature' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, "Mature"))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-xs"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-pastelPink-400 dark:text-purple-300"
  }, "Response Style"), /*#__PURE__*/React.createElement("div", {
    className: "flex bg-pastelPink-100/50 dark:bg-plum-900/50 p-0.5 rounded-lg border border-pastelPink-200/50 dark:border-plum-800"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setResponseStyle('cozy'),
    className: `px-2.5 py-1 rounded-md text-[10px] font-semibold transition-all ${responseStyle === 'cozy' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, "Cozy"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setResponseStyle('teasing'),
    className: `px-2.5 py-1 rounded-md text-[10px] font-semibold transition-all ${responseStyle === 'teasing' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, "Teasing"))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between text-xs"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-pastelPink-400 dark:text-purple-300"
  }, "Pushes Notifications"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setNotifications(!notifications),
    className: `w-9 h-5 rounded-full p-0.5 transition-all focus:outline-none ${notifications ? 'bg-pastelPink-400 dark:bg-purple-600' : 'bg-pastelPink-200 dark:bg-plum-900'}`
  }, /*#__PURE__*/React.createElement("div", {
    className: `w-4 h-4 rounded-full bg-white transition-all transform ${notifications ? 'translate-x-4' : 'translate-x-0'}`
  }))))), /*#__PURE__*/React.createElement("div", {
    className: "glass-panel rounded-2xl p-4"
  }, /*#__PURE__*/React.createElement("span", {
    className: "font-heading font-medium text-pastelPink-500 dark:text-purple-400 block mb-2.5"
  }, "Achievements Unlocked"), localState.achievements.length === 0 ? /*#__PURE__*/React.createElement("span", {
    className: "text-xs text-pastelPink-400 dark:text-purple-400 block text-center py-2"
  }, "No achievements unlocked yet.") : /*#__PURE__*/React.createElement("div", {
    className: "flex flex-wrap gap-1.5"
  }, localState.achievements.map((key, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
  ...
  }, achievementNames[key] || `🏆 ${key}`))))), /*#__PURE__*/React.createElement("div", {
    className: "p-4 border-t border-pastelPink-100/30 dark:border-plum-800 bg-pastelPink-50/20 dark:bg-plum-900/10 flex items-center justify-between text-xs"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: `w-2.5 h-2.5 rounded-full ${mode === 'backend' ? 'bg-green-400' : 'bg-yellow-400 animate-pulse'}`
  }), /*#__PURE__*/React.createElement("span", {
    className: "text-pastelPink-400 dark:text-purple-300 uppercase font-semibold"
  }, mode, " | ", currentGenderMode === 'girlfriend' ? 'GF' : 'BF')), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-2"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowSettingsModal(true),
    className: "p-1.5 rounded-md hover:bg-pastelPink-100/50 dark:hover:bg-plum-800 text-pastelPink-400",
    title: "API Settings"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "settings",
    className: "w-4 h-4"
    ...
    className: "glass-panel border-b px-4 py-3 flex items-center justify-between"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-10 h-10 rounded-full overflow-hidden border border-pastelPink-300 dark:border-purple-600"
  }, /*#__PURE__*/React.createElement("img", {
    src: "/xiaowei_avatar.jpg",
    alt: "Xiao Wei",
    className: "w-full h-full object-cover"
  })), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-0 right-0 w-3 h-3 rounded-full bg-green-500 border-2 border-white dark:border-plum-950 ring-pulse"
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-1.5"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "font-heading font-semibold text-base"
  }, "\u5C0F\u8587"), /*#__PURE__*/React.createElement("span", {
    className: "text-[10px] bg-pastelPink-100 dark:bg-purple-900/60 text-pastelPink-500 dark:text-purple-300 px-1.5 py-0.2 rounded-full font-medium capitalize"
  }, currentMod)), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-pastelPink-400 dark:text-purple-300"
  }, isTyping ? '💕 typing...' : moodStates[moodVal].subline))), /*#__PURE__*/React.createElement("div", {
    ...
    const isConsecutive = idx > 0 && messages[idx].role === messages[idx - 1].role && new Date(msg.timestamp) - new Date(messages[idx - 1].timestamp) < 120000;
    return /*#__PURE__*/React.createElement("div", {
      key: msg.id,
      className: `flex gap-2.5 max-w-[85%] sm:max-w-[75%] ${isAI ? 'self-start' : 'self-end ml-auto flex-row-reverse'} ${isConsecutive ? 'mt-1' : 'mt-4'}`
    }, isAI && /*#__PURE__*/React.createElement("div", {
      className: "w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border border-pastelPink-200 dark:border-purple-800"
    }, !isConsecutive ? /*#__PURE__*/React.createElement("img", {
      src: "/xiaowei_avatar.jpg",
      alt: "Companion Footprint",
      className: "w-full h-full object-cover"
    }) : /*#__PURE__*/React.createElement("div", {
      className: "w-full h-full bg-transparent"
    })), /*#__PURE__*/React.createElement("div", {
      className: "flex flex-col"
    }, !isConsecutive && /*#__PURE__*/React.createElement("span", {
      className: `text-[10px] text-pastelPink-400 dark:text-purple-300 mb-0.5 px-1 ${isAI ? 'self-start' : 'self-end'}`
    }, isAI ? '小薇' : 'You'), /*#__PURE__*/React.createElement("div", {
      className: `p-3 text-sm transition-all duration-300 ${isAI ? 'bubble-ai rounded-2xl rounded-tl-sm' : 'bubble-user rounded-2xl rounded-tr-sm'}`
    }, msg.type === 'text' && /*#__PURE__*/React.createElement("p", {
      className: "leading-relaxed break-words whitespace-pre-wrap"
    }, msg.text, msg.text === "" && /*#__PURE__*/React.createElement("span", {
      className: "typing-cursor"
    })), msg.type === 'image' && /*#__PURE__*/React.createElement("div", {
      className: "space-y-2"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "absolute inset-0 bg-black/10 hover:bg-black/0 transition-colors"
    })), msg.text && /*#__PURE__*/React.createElement("p", {
      className: "text-xs italic opacity-95"
    }, msg.text)), msg.type === 'voice' && /*#__PURE__*/React.createElement("div", {
      className: "space-y-1.5"
    }, /*#__PURE__*/React.createElement(WaveformMessage, {
      duration: msg.duration || '0:05',
      sender: msg.role
    }), msg.text && /*#__PURE__*/React.createElement("p", {
      className: "text-[11px] opacity-80 italic"
    }, msg.text))), /*#__PURE__*/React.createElement("span", {
      className: `text-[9px] text-pastelPink-300 dark:text-purple-400/70 mt-1 px-1 ${isAI ? 'self-start' : 'self-end'}`
    }, new Date(msg.timestamp).toLocaleTimeString([], {
      hour: '2-digit',
      minute: '2-digit'
    }))));
  }), messages.length <= 1 && /*#__PURE__*/React.createElement("div", {
    className: "mt-6 max-w-lg mx-auto space-y-4 p-4 rounded-3xl border border-pastelPink-100/40 dark:border-plum-800 glass-panel"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-center font-semibold text-pastelPink-400 dark:text-purple-300 uppercase tracking-widest"
  }, "Start with an idea"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 sm:grid-cols-2 gap-2.5"
  }, suggestedPrompts.map((p, idx) => /*#__PURE__*/React.createElement("button", {
    key: idx,
    ...
    className: "text-xs font-semibold text-pastelPink-500 dark:text-purple-400 group-hover:text-pastelPink-600 transition-colors mb-0.5"
  }, p.title), /*#__PURE__*/React.createElement("p", {
    className: "text-[11px] opacity-75 line-clamp-2 font-light"
  }, "\"", p.text, "\""))))), isTyping && /*#__PURE__*/React.createElement("div", {
    className: "flex gap-2.5 max-w-[70%] mt-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-8 h-8 rounded-full overflow-hidden flex-shrink-0 border border-pastelPink-200 dark:border-purple-800"
  }, /*#__PURE__*/React.createElement("img", {
    src: "/xiaowei_avatar.jpg",
    ...
    className: "bubble-ai rounded-2xl rounded-tl-sm p-3 flex items-center justify-center gap-1.5 h-9"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-2 h-2 rounded-full bg-pastelPink-400 dark:bg-purple-400 typing-dot"
  }), /*#__PURE__*/React.createElement("div", {
    className: "w-2 h-2 rounded-full bg-pastelPink-400 dark:bg-purple-400 typing-dot"
  }), /*#__PURE__*/React.createElement("div", {
    className: "w-2 h-2 rounded-full bg-pastelPink-400 dark:bg-purple-400 typing-dot"
  })))), /*#__PURE__*/React.createElement("div", {
    className: "px-4 text-[10px] text-center text-pastelPink-300 dark:text-purple-400/50 flex items-center justify-between pb-1.5"
  }, /*#__PURE__*/React.createElement("span", null, "Uptime Monitor: ", uptime), /*#__PURE__*/React.createElement("span", {
    className: "hidden sm:inline"
  }, "Personality Mod Selector in Sidebar config")), /*#__PURE__*/React.createElement("footer", {
    className: "glass-panel border-t p-3"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "flex-1 flex items-center gap-2 bg-pastelPink-100/40 dark:bg-plum-900/40 border border-pastelPink-200/50 dark:border-plum-800 rounded-2xl px-3 py-1.5 min-h-[44px]"
    ...
    className: "text-pastelPink-400 hover:text-pastelPink-500 p-1 rounded-full"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "smile",
    className: "w-5 h-5"
  }))), /*#__PURE__*/React.createElement("button", {
    ...
    className: `p-2.5 rounded-full transition-all duration-300 flex items-center justify-center shadow-md mb-0.5 ${inputValue.trim() ? 'bg-pastelPink-400 text-white hover:bg-pastelPink-500 scale-105 active:scale-95' : 'bg-pastelPink-100 text-pastelPink-300 dark:bg-plum-900 dark:text-purple-500 cursor-not-allowed'}`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "send",
    className: "w-4 h-4 fill-current rotate-45"
  }))))), activeCall && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/85 backdrop-blur-md text-white p-6 animate-fade-in"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col items-center max-w-sm w-full text-center space-y-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "relative flex justify-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-32 h-32 rounded-full overflow-hidden border-4 border-pastelPink-400 relative z-10 shadow-2xl"
  }, /*#__PURE__*/React.createElement("img", {
    src: "/xiaowei_avatar.jpg",
    alt: "Call Avatar",
    className: "w-full h-full object-cover"
  })), /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 rounded-full border border-pastelPink-300/40 ring-pulse z-0"
  })), /*#__PURE__*/React.createElement("div", {
    className: "space-y-1"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "font-heading font-semibold text-2xl"
  }, "\u5C0F\u8587 (Xiao Wei)"), /*#__PURE__*/React.createElement("span", {
    className: "text-sm text-pastelPink-400 font-semibold uppercase"
  }, activeCall, " Call")), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, /*#__PURE__*/React.createElement("p", {
    className: "text-base text-gray-300 font-medium"
  }, callStatus), callStatus === 'Connected' && /*#__PURE__*/React.createElement("p", {
    className: "font-mono text-2xl tracking-widest text-pastelPink-300 font-bold"
  }, formatCallTime(callTime))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-6 py-6"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setIsMuted(!isMuted),
    className: `p-4 rounded-full border transition-all ${isMuted ? 'bg-red-500/20 border-red-500 text-red-500' : 'bg-white/10 border-white/20 text-white hover:bg-white/20'}`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "mic",
    className: "w-6 h-6"
  })), activeCall === 'video' && /*#__PURE__*/React.createElement("button", {
    onClick: () => setIsCameraOff(!isCameraOff),
    className: `p-4 rounded-full border transition-all ${isCameraOff ? 'bg-red-500/20 border-red-500 text-red-500' : 'bg-white/10 border-white/20 text-white hover:bg-white/20'}`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "video",
    className: "w-6 h-6"
  }))), /*#__PURE__*/React.createElement("button", {
    ...
    className: "w-7 h-7 text-white fill-current transform rotate-[135deg]",
    viewBox: "0 0 24 24"
  }, /*#__PURE__*/React.createElement("path", {
    d: "M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"
  }))))), activeLightboxImage && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/90 p-4 animate-fade-in",
    onClick: () => setActiveLightboxImage(null)
  }, /*#__PURE__*/React.createElement("div", {
    className: "relative max-w-md w-full bg-white dark:bg-plum-900 rounded-2xl overflow-hidden shadow-2xl p-4 space-y-3"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setActiveLightboxImage(null),
    ...
    className: "font-handwriting text-2xl text-pastelPink-500 dark:text-purple-400"
  }, "\"For your eyes only! \uD83D\uDE09\" \u2014 \u5C0F\u8587")))), showSettingsModal && /*#__PURE__*/React.createElement("div", {
    className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in"
  }, /*#__PURE__*/React.createElement("div", {
    className: "glass-panel w-full max-w-md rounded-3xl p-6 relative flex flex-col space-y-4"
  }, /*#__PURE__*/React.createElement("div", {
    className: "flex items-center justify-between border-b pb-3 border-pastelPink-100/30"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "font-heading font-semibold text-lg text-pastelPink-500 dark:text-purple-400"
  }, "App Configurations"), /*#__PURE__*/React.createElement("button", {
    ...
    className: "text-xs font-semibold text-pastelPink-400 uppercase tracking-wider block mb-1.5"
  }, "Theme Settings"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-2 bg-pastelPink-100/50 dark:bg-plum-900/50 p-1 rounded-xl"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setTempTheme('light'),
    className: `py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 transition-all ${tempTheme === 'light' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "sun",
    className: "w-4 h-4"
  }), " Light Mode"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setTempTheme('dark'),
    className: `py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 transition-all ${tempTheme === 'dark' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "moon",
    className: "w-4 h-4"
  }), " Dark Mode"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-semibold text-pastelPink-400 uppercase tracking-wider block mb-1.5"
  }, "Personality Mod"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-2 max-h-32 overflow-y-auto pr-1"
  }, modSelectorItems.map(item => /*#__PURE__*/React.createElement("button", {
    key: item.key,
    onClick: () => setCurrentMod(item.key),
    className: `p-2 rounded-xl text-left border flex items-center gap-2 transition-all ${currentMod === item.key ? 'border-pastelPink-400 bg-pastelPink-50 dark:bg-purple-900/20 text-pastelPink-500 dark:text-purple-300' : 'border-pastelPink-100/30 hover:border-pastelPink-300 dark:border-plum-800'}`
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-base"
  ...
  }, item.desc)))))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "text-xs font-semibold text-pastelPink-400 uppercase tracking-wider block mb-1.5"
  }, "Processing Engine"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-2 gap-2 bg-pastelPink-100/50 dark:bg-plum-900/50 p-1 rounded-xl"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => setTempMode('local'),
    className: `py-1.5 rounded-lg text-xs font-semibold transition-all ${tempMode === 'local' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, "Local Engine"), /*#__PURE__*/React.createElement("button", {
    onClick: () => setTempMode('backend'),
    className: `py-1.5 rounded-lg text-xs font-semibold transition-all ${tempMode === 'backend' ? 'bg-white dark:bg-purple-600 text-pastelPink-500 dark:text-white shadow-sm' : 'text-pastelPink-400'}`
  }, "FastAPI Server"))), tempMode === 'backend' && /*#__PURE__*/React.createElement("div", {
    className: "space-y-3.5 p-3 rounded-2xl bg-pastelPink-100/30 dark:bg-plum-900/30 border border-pastelPink-200/40 dark:border-plum-800"
  }, /*#__PURE__*/React.createElement("div", {
    className: "space-y-1"
  }, /*#__PURE__*/React.createElement("label", {
    className: "text-[11px] font-semibold text-pastelPink-400 dark:text-purple-300 block"
  }, "Backend Server URL"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    ...
    className: "text-[11px] font-semibold text-pastelPink-400 dark:text-purple-300 block"
  }, "Groq API Key"), /*#__PURE__*/React.createElement("input", {
    type: "password",
    value: tempGroqKey,
    ...
    className: "text-[11px] font-semibold text-pastelPink-400 dark:text-purple-300 block"
  }, "Language Model"), /*#__PURE__*/React.createElement("select", {
    value: tempGroqModel,
  ...
  }, "Llama 3.3 70B"), /*#__PURE__*/React.createElement("option", {
    value: "llama3-70b-8192"
  }, "Llama 3 70B (Fast)"), /*#__PURE__*/React.createElement("option", {
    value: "llama3-8b-8192"
  }, "Llama 3 8B"), /*#__PURE__*/React.createElement("option", {
    value: "mixtral-8x7b-32768"
  }, "Mixtral 8x7B"), /*#__PURE__*/React.createElement("option", {
    value: "gemma2-9b-it"
  }, "Gemma 2 9B"))))), /*#__PURE__*/React.createElement("div", {
